                ...
                if platform == "bilibili":
                    ...
                    for id in dict_platforms[platform]:
                        try:
                            ...
                            upload_task_dict["bilibili"][id] = {"status": "success"}
                    ...
                    for id in dict_platforms[platform]:
                        try:
                            ...
                            upload_task_dict["xiaohongshu"][id] = {"status": "success"}
                        except Exception as e:
                    ...
                    for id in dict_platforms[platform]:
                        try:
                            ...
                            upload_task_dict["tencent"][id] = {"status": "success"}
                        except Exception as e:
                    ...
                    for id in dict_platforms[platform]:
                        try:
                            ...
                            upload_task_dict["douyin"][id] = {"status": "success"}
                        except Exception as e:
                    ...
                    for id in dict_platforms[platform]:
                        try:
                            ...
                            upload_task_dict["kuaishou"][id] = {"status": "success"}
                        except Exception as e:
