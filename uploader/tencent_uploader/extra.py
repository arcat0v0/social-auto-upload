...
class TencentVideo(object):
    ...
    async def upload(self, playwright: Playwright) -> None:
        ...
        register_tencent_login(self.account_id, json.dumps(login_info))
        ...
        while True:
            try:
                ...
                await page.wait_for_url(
                    "https://channels.weixin.qq.com/platform/post/list", timeout=1500
                )
...
def upload_video_to_tencent(
    ...
    app = TencentVideo(
        ...
        video_path,
        tags,
        float(timestamp) if timestamp is not None else future_time.timestamp(),
        cookies,
        category,
    )
